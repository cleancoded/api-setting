 ...
 *
 * Cleancoded api plugin example is given on the main plugin file.
 *
 ...
 */
if ( !function_exists( 'cleancoded_admin_init' ) ):
    function cleancoded_admin_init() {
        ...
        $settings_api = new Cleancoded_Settings_API;
...
add_action( 'admin_init', 'cleancoded_admin_init' );
